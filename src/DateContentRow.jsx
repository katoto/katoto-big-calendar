...
import BackgroundCells from './BackgroundCells.jsx'
...
class DateContentRow extends React.Component {
  ...
  renderHeadingCell = (date, index) => {
    ...
    return renderHeader({
      date,
      key: `header_${index}`,
      className: classNames('rbc-date-cell', {
  ...
  renderDummy = () => {
    ...
    return (
      <div className={className}>
        <div
          className={classNames('rbc-row-content', {
  ...
  render() {
    ...
    // 排序
    if (this.props.localizer && this.props.localizer.messages.eventRowsSort) {
      levels = this.props.localizer.messages.eventRowsSort(levels) || []
    }
    ...
    return (
      <div className={classNames(className)} role="rowgroup"
        onClick={(e) => {
          rowLineClick(rowInx, e)
        }}
      >
        <BackgroundCells
          localizer={localizer}
        ...
        >
          ...
          <ScrollableWeekComponent>
            <div className='week-wrapper-box' >
...
DateContentRow.propTypes = {
  ...
  rowInx: PropTypes.number,
  rowLineClick: PropTypes.func
}
