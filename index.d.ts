...
export interface Components<TEvent extends object = Event, TResource extends object = object> {
    ...
    popWrapper?: React.ComponentType | undefined;
...
export interface Messages {
    ...
    showMore?: ((count: number) => void) | undefined;
...
export class DateLocalizer {
    ...
    firstVisibleDay: (str: string) => void;
    lastVisibleDay: (str: string) => void;
...
export interface CalendarProps<TEvent extends object = Event, TResource extends object = object> {
    ...
    onMouseMoveEvent?: ((points: number[]) => void) | undefined;
